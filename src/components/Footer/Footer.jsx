    ...
    <footer className="border-t border-slate-200 bg-white text-slate-500 py-8 px-6 text-xs">
      <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 font-bold text-slate-900 text-sm">
          <div className="w-5 h-5 rounded bg-blue-600 flex items-center justify-center text-white flex-shrink-0">
            <Laptop className="w-3 h-3" />
          </div>
          <span>
            Our<span className="text-blue-600">Space</span>
          </span>
          <span className="hidden sm:inline text-slate-400 font-normal text-xs ml-2">
